window.addEventListener("load", () => {
    ...
    // === 5. Projects Render with Lazy Videos ===
    const works = [
    ...
    function drawOrbs(){
        ...
        const accent=getAccentRGBA();
        orbs.forEach(o=>{o.x+=o.dx;o.y+=o.dy;if(o.x<-o.r)o.x=width+o.r;if(o.x>width+o.r)o.x=-o.r;if(o.y<-o.r)o.y=height+o.r;if(o.y>height+o.r)o.y=-o.r;
